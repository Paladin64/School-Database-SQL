...
CREATE TABLE `staff` (
  ...
  `course_ids` int(11) DEFAULT NULL,
  PRIMARY KEY (`staff_id`),
  UNIQUE KEY `staff_id_UNIQUE` (`staff_id`),
  KEY `program_id_idx` (`program`),
  CONSTRAINT `program_teaching_id` FOREIGN KEY (`program`) REFERENCES `certificate` (`program_id`)
...
INSERT INTO `staff` VALUES (1,'Fredrick Pederson',39,2,NULL),(2,'Levi Smith',43,1,NULL);
